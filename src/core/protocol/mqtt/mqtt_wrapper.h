#ifndef _IOT_WRAPPER_MQTT_H_
#define _IOT_WRAPPER_MQTT_H_
...
#define CONFIG_MQTT_REQUEST_TIMEOUT             (4000)
...
#define CONFIG_MQTT_RECEIVE_PACKAGE_TIMEOUT     (10 * 1000)
#endif
